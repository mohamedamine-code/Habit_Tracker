...
const AppSettingSchema = CollectionSchema(
  ...
  properties: {
    r'FirstlanchDate': PropertySchema(
      id: 0,
      name: r'FirstlanchDate',
...
void _appSettingSerialize(
  ...
  writer.writeDateTime(offsets[0], object.FirstlanchDate);
}
...
AppSetting _appSettingDeserialize(
  ...
  object.FirstlanchDate = reader.readDateTimeOrNull(offsets[0]);
  object.id = id;
  return object;
}
...
extension AppSettingQueryFilter
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterFilterCondition>
      firstlanchDateIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'FirstlanchDate',
      ));
    });
  }

  QueryBuilder<AppSetting, AppSetting, QAfterFilterCondition>
      firstlanchDateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterFilterCondition>
      firstlanchDateEqualTo(DateTime? value) {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingQuerySortBy
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> sortByFirstlanchDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'FirstlanchDate', Sort.asc);
    });
  }

  QueryBuilder<AppSetting, AppSetting, QAfterSortBy>
      sortByFirstlanchDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'FirstlanchDate', Sort.desc);
    });
  }
}
...
extension AppSettingQuerySortThenBy
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> thenByFirstlanchDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'FirstlanchDate', Sort.asc);
    });
  }
...
extension AppSettingQueryWhereDistinct
  ...
  QueryBuilder<AppSetting, AppSetting, QDistinct> distinctByFirstlanchDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'FirstlanchDate');
    });
  }
}
...
extension AppSettingQueryProperty
  ...
  QueryBuilder<AppSetting, DateTime?, QQueryOperations>
      FirstlanchDateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'FirstlanchDate');
    });
  }
}
