...
int _habitEstimateSize(
  ...
  bytesCount += 3 + object.compltedDays.length * 8;
...
void _habitSerialize(
  ...
  writer.writeDateTimeList(offsets[0], object.compltedDays);
...
Habit _habitDeserialize(
  ...
  final object = Habit();
  object.compltedDays = reader.readDateTimeList(offsets[0]) ?? [];
  object.id = id;
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  QueryBuilder<Habit, Habit, QAfterFilterCondition> compltedDaysElementEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'compltedDays',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      compltedDaysElementGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> compltedDaysElementLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> compltedDaysElementBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> compltedDaysLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> compltedDaysIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'compltedDays',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> compltedDaysIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'compltedDays',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> compltedDaysLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> compltedDaysLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitQueryWhereDistinct on QueryBuilder<Habit, Habit, QDistinct> {
  QueryBuilder<Habit, Habit, QDistinct> distinctByCompltedDays() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'compltedDays');
    });
  }
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, List<DateTime>, QQueryOperations> compltedDaysProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'compltedDays');
    });
  }
